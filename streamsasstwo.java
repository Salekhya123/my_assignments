...
public class streamsasstwo {
        public static void main(String[] args)
        {
            News s1=new News(1,"salekhya","srimanya","budget");
            News s2=new News(2,"srimanya","salekhya","good");
            News s3=new News(3,"salekhya","poojitha","excellent");
